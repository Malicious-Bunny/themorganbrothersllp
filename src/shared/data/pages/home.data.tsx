...
export const testimonialsHome: TestimonialsProps = {
  ...
  header: {
    ...
    subtitle: 'Real results from real people whose lives we have changed',
  ...
  testimonials: [
    {
      name: 'Maria G.',
      job: 'DACA Recipient',
      testimonial: `Morgan Dauterive LLP helped me renew my DACA status when I thought all hope was lost. They guided me through every step and kept me informed throughout the process.`,
      image: {
    ...
    },
    {
      name: 'Carlos R.',
      job: 'Asylum Granted',
      testimonial: `After years of fear, this firm helped me win my asylum case. Their expertise in immigration law gave me the protection I desperately needed.`,
      image: {
    ...
    },
    {
      ...
      testimonial: `Thanks to Morgan Dauterive LLP, I was able to adjust my status and get my green card. They made the impossible possible for my family.`,
      image: {
...
export const pricingHome: PricingProps = {
  ...
  hasBackground: true,
  header: {
    title: 'Transparent Pricing for Immigration Services',
    subtitle: 'Affordable legal representation with flexible payment options',
    tagline: 'Pricing',
  },
  prices: [
    {
      title: 'Consultation',
      subtitle: 'Case evaluation and strategy planning',
      price: 300,
      period: 'per session',
      items: [
        {
        ...
        {
          description: 'Personalized strategy development',
        },
        {
          description: 'Document review and requirements',
        },
        {
    ...
    {
      title: 'DACA Services',
      subtitle: 'Initial applications and renewals',
      price: 2500,
      period: 'full service',
      items: [
        {
          description: 'Complete application preparation',
        },
        {
          description: 'Document gathering assistance',
        },
        {
          description: 'Filing and follow-up',
        },
        {
          description: 'Response to RFEs',
        },
      ],
      callToAction: {
        text: 'Get Started',
    ...
    {
      title: 'Asylum Cases',
      subtitle: 'Full representation from start to finish',
      price: 6000,
      period: 'complete case',
      items: [
        {
        ...
        {
          description: 'Evidence gathering support',
        },
        {
          description: 'Appeals if necessary',
        },
      ],
      callToAction: {
        text: 'Learn More',
