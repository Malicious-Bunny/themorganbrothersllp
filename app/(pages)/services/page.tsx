...
const servicesPricing = {
  ...
  header: {
    ...
    subtitle: 'Fair, upfront pricing with flexible payment options',
    tagline: 'Pricing',
  },
  prices: [
    {
      title: 'Initial Consultation',
      subtitle: 'Case assessment and strategy',
      price: 300,
      period: 'per session',
      items: [
        ...
        { description: 'Document requirements review' },
      ],
      callToAction: {
        text: 'Schedule Now',
        href: '/contact',
    ...
    {
      title: 'DACA Services',
      subtitle: 'Complete application assistance',
      price: 2500,
      period: 'full service',
      items: [
        { description: 'Application preparation and filing' },
        { description: 'Document gathering assistance' },
        { description: 'Response to government requests' },
        { description: 'Renewal assistance included' },
      ],
      callToAction: {
        text: 'Get Started',
        href: '/daca',
    ...
    {
      title: 'Asylum Cases',
      subtitle: 'Full legal representation',
      price: 6000,
      period: 'complete case',
      items: [
        { description: 'Comprehensive case preparation' },
        { description: 'Court representation' },
        { description: 'Evidence gathering and expert witnesses' },
        { description: 'Appeals assistance if needed' },
      ],
      callToAction: {
        text: 'Learn More',
        href: '/asylum',
